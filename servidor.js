...
import fs from 'fs';
    ...
    function darBienvenida(req, res) {
      ...
      fs.readFile('bienvenida.html', 'utf8', (error, data) => {
        if (error) {
           ...
           //Se utiliza cuando el servidor encuentra una condición inesperada que le impide cumplir con la solicitud. 
          res.writeHead(500, { 'Content-Type': 'text/plain' });
          res.end('Oh no!!!!');
          return;
        }
        //Escribe qué significa el 200
        //El código 200 en HTTP significa "OK", lo que indica que la solicitud del cliente se procesó correctamente sin errores.
    ...
    function getEscuelas(req, res) {
      ...
      //stringify lo utilizamos para convertir el json en un string escribible en el html
    ...
    function getEquipo(req, res) {
      ...
      res.writeHead(200, { 'Content-Type': 'application/json' });
      res.end(JSON.stringify(miembros));
    }
